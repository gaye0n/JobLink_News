    ...
    private void DisplayData()
    {
        ...
        using (Is.Notice.Bsl.Notice_RTx bsl = new Is.Notice.Bsl.Notice_RTx())
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                lblwriter.Text = ds.Tables[0].Rows[0]["writer"].ToString();
                lblDateMonthYear.Text = ds.Tables[0].Rows[0]["DateMonthYear"].ToString();
                lblMemo.Text = ds.Tables[0].Rows[0]["Memo"].ToString();
