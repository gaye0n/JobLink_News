...
<asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
        ...
        <table width=98%  border="0" cellpadding="0" cellspacing="0"> 
			<tr><td height="30" colspan=9 align=center bgcolor="#5D7B9D"><font color="#ffffff"><b>새 소식 News</b></font></td></tr>
                            ...
                            <ContentTemplate>
                                <asp:GridView ID="ctlNoticeList" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                                    ...
                                    <Columns>
					                    ...
					                    <asp:TemplateField HeaderText="기사 제목">
                                            <ItemTemplate>
                                                <a href='SCM_NoticeView.aspx?SCM_NewsID=<%#Eval("SCM_NewsID") %>'>
                                                    <%#FuncCutStrng(Eval("NewsTitle"))%>
                                                    &nbsp;
                                    ...
                                    <asp:TemplateField HeaderText ="분야">
                                        <ItemTemplate>                                     
                                            <%#FuncCutStrng(Eval("section"))%>	                                 
                                        </ItemTemplate>
                    ...
                    <td height="40" align="right" valign="top">
                         <asp:Panel ID="Panel1" runat="server" Width="100%" DefaultButton="btnSearch">
                             <asp:DropDownList ID="lstField" runat="server" CssClass="DropList">
                                 <asp:ListItem Selected="True" Value="NewsTitle">제목</asp:ListItem> 
                                  <asp:ListItem Value="section">분야</asp:ListItem>
                             </asp:DropDownList></td>                        
